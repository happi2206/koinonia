<template>
  <div class="">
    ...
    >
      <div
        class="dropdown account-dropdown my-2 my-md-0 d-flex align-items-center"
      >
        <div class="mr-2">
          <div class="d-flex align-items-center icontoggle">
            <div class="icon-wrapper active borderright">
              <svg
                width="14"
                height="14"
                viewBox="0 0 14 14"
        ...
        <span class="text-dark medbrownparagraph mx-2"> Viewed by</span>
        <a
          href="#"
          class="
            dropdown-toggle
