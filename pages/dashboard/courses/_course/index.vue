  ...
  methods: {
    ...
    async createStudent() {
      try {
        ...
        await this.$axios.$post(
          `course-v/add-flat-students-to-a-course?course_id=${this.$route.params.course}`, this.student
        )
    ...
    async createEvent() {
      try {
        ...
        // this.event.start_date = start_date.toISOString()

        // let end_date = new Date(this.event.end_date)
        // this.event.end_date = end_date.toISOString()
        console.log(this.event.end_date, this.event.start_date)
        
        await this.$axios.$post(
          `course-v/add-course-event?course_id=${this.$route.params.course}`, this.event
        )
